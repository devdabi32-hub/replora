  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black px-4 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-[#0084ff]/10 rounded-full blur-[120px]" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <p className="text-center text-[11px] text-white/30 mt-5">By signing up you agree to our Terms & Privacy Policy</p>
      </div>
    </div>
  );
}