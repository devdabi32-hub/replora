  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto">
      <div className="flex items-start justify-between mb-6 flex-wrap gap-4">
        ...
        <div className="flex items-center gap-2 bg-white border border-white/10 rounded-xl px-4 py-2.5 shadow-sm">
      ...
      <div className="bg-white border border-white/10 rounded-2xl overflow-hidden shadow-sm">
        <div className="p-4 border-b border-white/10">
          <div className="relative max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-3 py-2.5 text-sm rounded-xl bg-white/10 border border-transparent focus:bg-white focus:border-[#0084ff] focus:ring-2 focus:ring-blue-500/30 outline-none transition-all"
            />
          </div>
        </div>
